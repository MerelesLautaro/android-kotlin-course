# Banking App – Android (Kotlin + Jetpack Compose)

Aplicación Android desarrollada como cliente móvil para una API bancaria.
El objetivo de este proyecto fue practicar desarrollo moderno en Android utilizando **Kotlin y Jetpack Compose**, además de servir como proyecto de portafolio para posiciones de **Android Developer**.
...
El proyecto sigue una arquitectura **Clean Architecture simplificada** con separación clara de responsabilidades.
...
di/
 └── ServiceLocator / AppContainer
```

### Capas

**UI (Jetpack Compose)**
Contiene las pantallas, componentes reutilizables y manejo del estado visual.

**ViewModel**
Gestiona el estado de cada pantalla y coordina la interacción con los repositorios.

**Domain**
Define las interfaces de repositorio que abstraen la lógica de acceso a datos.

**Data**
Implementaciones de los repositorios, llamadas a la API y almacenamiento local.

**Dependency Injection**
Se utiliza un **Service Locator + AppContainer** para mantener las dependencias centralizadas sin introducir frameworks adicionales.
...
Las operaciones financieras se realizan a través de **modales dinámicos** que reutilizan un mismo componente de diálogo para las diferentes acciones.
...
*(Puedes agregar screenshots aquí si lo deseas)*
...
* profundizar en **Jetpack Compose**
* aplicar **arquitectura limpia en Android**
* implementar consumo de APIs REST
* construir un proyecto realista de portafolio para roles de **Android Developer**
...
El backend de esta aplicación fue desarrollado utilizando:

* **Java**
* **Spring Boot**
* **REST API**

Este backend fue originalmente creado durante un **hackathon organizado por CaixaBank**, donde se definieron requerimientos para simular operaciones básicas de un sistema bancario.
...
### link del repositorio del backend: https://github.com/MerelesLautaro/banking-app-project/tree/master/lautadev/lautadev
